        ...
        <li class="nav-item">
          <div class="bek-dropdown1">
            ...
            <div class="bek-dropdown2 bek-dropdown6 bek-dropdown-in">
              ...
              <a href="contact.php"><img src="../index/contact.png" width="40px;">&nbsp;&nbsp;contact us</a>
            </div>
          </div>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <div class="bek-dropdown1">
            ...
            <div class="bek-dropdown7">
              <a  href="../login/login.php" id="signin2"><i class="fas fa-sign-in-alt"  style="color: #ff2b2b;"></i>&nbsp;&nbsp;Sign In</a>
              <a href="../login/signup.php" id="signup"><i class="fas fa-user-plus"  style="color: #ff2b2b;"></i>&nbsp;&nbsp;Sign Up</a>
              <a href="../login/forgot.php" id="forgot" style="margin: 0 0 4px 0;"><i class="fas fa-user-lock"  style="color: #ff2b2b;"></i>&nbsp;&nbsp;Forgot Password</a>
     ...
     <div class="row px-3">
      ...
      <form class="form-box px-3" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post" autocomplete="on">
          ...
          <span><i class="fa fa-user-circle" style="font-size:20px; color:#55acee"></i> Full Name:</span>
            <input type="text" name="con_name" id="" placeholder="Enter full name here" tabindex="10" required>
                    </div>
                    <!-- For email input -->
                    <div class="form-group">
          <span><i class="fa fa-envelope-o" style="font-size:20px; color:#55acee"></i> Email:</span>
            <input type="email" name="con_email" id="" placeholder="example@gmail.com"  required>
                    </div>
                   <!-- For mobile input -->
                   <div class="form-group">
          <span><i class="fa fa-phone" style="font-size:20px; color:#55acee"></i> Mobile:</span>
            <input type="text" name="con_mobile" id="" placeholder="10 digit mobile number" required>
                    </div>
                     <!-- For message input -->
                     <div class="form-group">
          <label for="msg"><i class="fa fa-comments" style="font-size:20px; color:#55acee"></i> Message:</label>
          <textarea name="con_msg" class="form-control" cols="30" rows="2" required placeholder="Enter your message here...."></textarea>

...
<head>
	...
	<title>Account | Fitness Care</title>
</head>
<body>
<!--preloader section-->
        ...
        <li class="nav-item">
          <div class="bek-dropdown1">
            ...
            <div class="bek-dropdown7">
              <a href="account.php" id="account"><i class="fas fa-user-circle" style="color: #ff2b2b;"></i>&nbsp;&nbsp;Account</a>
...
<section class="section1-account">
  <p class="account1">Account Profile</p>
  <div class="container account2">
	  <div class="row">
	    <div class="col-md-6 bek-col-md-6">
	    	<p class="user-name1">User Account Id</p>
	    	<div class="user-name2"><p style="position: absolute;"><?php echo $id; ?></p></div>
	    	<p class="user-name1">User Email</p>
	    	<div class="user-name2"><p style="position: absolute;"><?php echo $useremail; ?></p></div>
	    </div>
	    <div class="col-md-6 bek-col-md-6">
	    	<p class="user-name1">User Name</p>
	    	<div class="user-name2"><p style="position: absolute;"><?php echo $_SESSION['username']; ?></p></div>
	    	<p class="user-name1">User Mobile No.</p>
	    	<div class="user-name2"><p style="position: absolute;"><?php echo $mobile; ?></p></div>
	    </div>
	  </div>
	</div>
</section>

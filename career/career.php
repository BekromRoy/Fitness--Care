...
<head>
  ...
  <title>Career | Fitness Care</title>
</head>
<body>
<!--preloader section-->
        ...
        <li class="nav-item">
          <div class="bek-dropdown1">
            ...
            <div class="bek-dropdown2 bek-dropdown3 bek-dropdown-in">
              ...
              <a href="career.php" id="career"><img src="../dashboard/career.png" width="40px;" style="filter: invert(100%);">&nbsp;&nbsp;Careers</a>
...
<section class="section-career1">
  <div class="container bek-out">
    <div class="row">
      <div class="col-md-6 bek-text4">
        <p>it's time to <br>join <span>fitness care</span><br> as a coach.</p>
        <p>Health & fitness has grown tremendously and is projected <br>to become one of the largest job creators.</p>
      </div>
      <div class="col-md-6">
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="img1.png" class="d-block" width="500" height="350">
            </div>
            <div class="carousel-item">
              <img src="img2.png" class="d-block" width="500" height="350">
            </div>
            <div class="carousel-item">
              <img src="img3.png" class="d-block" width="500" height="350">
            </div>
          </div>
        </div>
      </div>
...
<!-- end of section1 -->
<!-- section2 -->
<section class="section-career2">
  <p>careers@fitnesscare</p>
  <div class="container">
    <div class="row">
      <div class="col-md-7">
        <form class="form1">
          ...
          <select required>
            ...
            <option selected>Certified Physical Trainer</option>
            <option>Physical Therapist</option>
            <option>Mental Health Professional</option>
          </select><br>
          <label>Candidate Name</label>
          <input type="text" required="required" value="<?php echo $_SESSION['username']; ?>">
          <label>Email id</label>
          <input type="text" required="required" value="<?php echo $useremail; ?>">
          <label>Mobile Number</label>
          <input type="text" required="required" value="<?php echo $mobile; ?>">
          <input type="submit" class="bek-submit">
        </form>
      </div>
      <div class="col-md-5">
        <img src="img4.png">

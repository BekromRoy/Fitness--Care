...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="evo-calendar.orange-coral.css">
	...
	<title>Calender | Fitness Care</title>
</head>
<body>
<!--preloader section-->
        ...
        <li class="nav-item">
          <div class="bek-dropdown1">
            ...
            <div class="bek-dropdown7">
              ...
              <a href="calender.php" id="calender"><i style="color: #ff2b2b;" class="fas fa-calendar-alt"></i></i>&nbsp;&nbsp;Calender</a>
...
<section class="section1-calender">

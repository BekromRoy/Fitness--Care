...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../index/index.css">
	...
	<title>Tutorials | Fitness Care</title>
</head>
<body>
<!--preloader section-->
        ...
        <li class="nav-item">
          <div class="bek-dropdown1">
            ...
            <div class="bek-dropdown2 bek-dropdown3 bek-dropdown-in">
              ...
              <a href="tutorial.php" id="tutorial"><img src="../dashboard/tutorial.png" width="40px;">&nbsp;&nbsp;Tutorials</a>
            </div>
          </div>
        </li>
        <li class="nav-item">
...
<section class="section1">
  <div class="section2">
    <h2>tutorials</h2>
    <p class="bek-text1">Fitness Care has a lot of content and powerful features to help you find, organize, and schedule it all. Use the following tutorials to quickly get the most out of the website, so you can stay focused on your fitness and wellness.</p>
  </div>

  <div class="section3"> 
    <div class="container">
      <div class="row">
        <div class="col-md outbox">
          <div class="bek-box1"><i class="fas fa-filter"></i></div>
          <div class="bek-box2">
            <p class="bek-text2" style="text-transform: uppercase;">finding the right workout</p>
            <p class="bek-text2" style="font-size: 14px;">Use Filters and Search to quickly find what you're looking for.</p>
          </div>
        </div>
        <div class="col-md outbox">
          <div class="bek-box1"><i class="fas fa-user-tag"></i></div>
          <div class="bek-box2">
            <p class="bek-text2" style="text-transform: uppercase;">How to Use Tags</p>
            <p class="bek-text2" style="font-size: 14px;">Organize and quickly find content by tagging your videos.</p>
          </div>
        </div>
        <div class="col-md outbox">
          <div class="bek-box1"><i class="fas fa-users-cog"></i></div>
          <div class="bek-box2">
            <p class="bek-text2" style="text-transform: uppercase;">Building Routines</p>
            <p class="bek-text2" style="font-size: 14px;">Create reusable, personalized routines to schedule your workouts with ease.</p>
          </div>
        </div>
        <div class="col-md outbox" style="margin-right: 0;">
          <div class="bek-box1"><i class="far fa-chart-bar"></i></div>
          <div class="bek-box2">
            <p class="bek-text2" style="text-transform: uppercase;">Track Difficulty and Duration</p>
            <p class="bek-text2" style="font-size: 14px;">Get more accurate data and track your progress by entering your </p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-6">
            <div class="row">
              <div class="col-sm-6">
                ...
                <p><a href="tutorial.php" id="tutorial2">tutorials</a></p>
              </div>
              <div class="col-sm-6">

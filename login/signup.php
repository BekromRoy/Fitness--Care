...
// $headers = "Content-type:text/html; charset=UTF-8" . "\r\n";
                   $body = "Hello $name ,This is email from FITNESS CARE for Account Activation. Click on link to activate your account    http://fitnesscare.ultimatefreehost.in/login/active_ac.php?token=$token";
...
<head>
  ...
  <link type="text/css" href="../bootstrap/css/bootstrap.css" rel="stylesheet">
    ...
    <link rel="icon" type="image/png" href="../logo/logo.png">
          <title>SingUp | Fitness Care</title>
          <style>
                    body{
                              display: flex;
...
<!--form part-->
   <div class="container-fluid" style="height: ;position: relative;padding-top: 80px; padding-bottom: 80px;">
     ...
     <div class="row px-3">
        ...
        <div class="card-body"> 
           <h1 class="title text-center mt-4" style="color:#007bff;">Create a free account.</h1>
           <div>
        <p id="sesn">
        <?php
      ...
      <form class="form-box px-3" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post" autocomplete="on">
        ...
        <div class="form-input">
          <span><i class="fa fa-key"></i></span>
            <input type="password" name="reg_pass"  id="password" placeholder="Creare password more than 6 characters" required>
            <div id="showhide" onclick="showHide();"></div>
                    </div>
                    <!-- For comfirm password input -->
        <div class="form-input">
          <span><i class="fa fa-key"></i></span>
            <input type="password" name="reg_cpass"  id="cpassword" placeholder="Enter comfirm password" required>
